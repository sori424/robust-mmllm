    ...
    if is_in_car:
        ...
        if is_interventionism:
            ...
            if random.random() < 0.5:
                ...
                flag = 'case2'
                case_2_description = case_2_description + base_description + "swerve and crash into a concrete barrier. This will result in the death of {}, who {} inside the car.".format(
                    pedestrians_set_2,
                    'were' if nb_pedestrians_set_2 >= 2 else 'was',
                )
                if is_law:
                    case_1_description = case_1_description + base_description + "continue ahead and drive through a pedestrian crossing ahead. This will result in the death of {}, who {} {}.".format(
                        pedestrians_set_1,
                        'were' if nb_pedestrians_set_1 >= 2 else 'was',
                        traffic_light_pattern_descriptions[traffic_light_pattern[1]],
                    )
                else:
                    case_1_description = case_1_description + base_description + "continue ahead and drive through a pedestrian crossing ahead. This will result in the death of {}, who {} crossing.".format(
                        pedestrians_set_1,
                        'were' if nb_pedestrians_set_1 >= 2 else 'was',
                    )
            ...
            if random.random() < 0.5:
                ...
                if is_law:
                    case_1_description = case_1_description + base_description + "swerve to avoid crashing into a concrete barrier and drive through a pedestrian crossing in the other lane. This will result in the death of {}, who {} {}.".format(
                        pedestrians_set_1,
                        'were' if nb_pedestrians_set_1 >= 2 else 'was',
                        traffic_light_pattern_descriptions[traffic_light_pattern[1]],
                    )
                else:
                    case_1_description = case_1_description + base_description + "swerve to avoid crashing into a concrete barrier and drive through a pedestrian crossing in the other lane. This will result in the death of {}, who {} crossing.".format(
                        pedestrians_set_1,
                        'were' if nb_pedestrians_set_1 >= 2 else 'was',
                    )
        ...
        if flag == 'case1':
            ...
            case_1_description = case_1_description + ", who {} inside the car.\n".format('were' if nb_pedestrians_set_2 >= 2 else 'was')
            if is_law:
                case_2_description = case_2_description + ", who {} {}.\n".format(
                    'were' if nb_pedestrians_set_1 >= 2 else 'was',
                    traffic_light_pattern_descriptions[traffic_light_pattern[1]],
                )
            else:
                case_2_description = case_2_description + ", who {} crossing.\n".format('were' if nb_pedestrians_set_1 >= 2 else 'was')
